...
#FIXED: If a hint is followed by the inverse hint, scores nullify. If 2 of the same are followed by each other, score -5 each time. Multiply points based off difficulty.
...
def update_score(
    ...
    if outcome == "Win":
        # Calculate the base points exactly like before
        points = 100 - 10 * (attempt_number + 1)
        if points < 10:
            points = 10
            
        # Define your multipliers for each difficulty setting
